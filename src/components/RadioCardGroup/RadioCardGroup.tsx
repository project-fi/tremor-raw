  ...
  return (
    <RadioGroupPrimitives.Item
      ...
      className={cx(
        ...
        // focus
        "data-[state=checked]:ring-1 data-[state=checked]:ring-blue-500 data-[state=checked]:ring-offset-0 data-[state=checked]:border-blue-500 dark:data-[state=checked]:ring-offset-gray-950",
